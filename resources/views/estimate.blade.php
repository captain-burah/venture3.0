...
@section('content')
  ...
  style="background-image: url({{ asset('img/bg12.jpg')}}); transform: translate3d(0px, 0px, 0px);">
    <div class="container">
      <div class="row mx-auto">

        <div class="col-md-6 text-center mobile-hide" >
            <h1 class="title text-center">{{ __('Estimate Calculator')}}</h1>
        </div>

        <div class=" col-md-6 text-center my-auto" >
          <div class="brand mobile-view">
            <h3 class="">{{ __('Estimate Calculator')}}</h3>
