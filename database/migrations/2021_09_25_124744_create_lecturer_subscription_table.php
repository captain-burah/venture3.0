...
class CreateLecturerSubscriptionTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('lecturer_subscription', function (Blueprint $table) {
            $table->increments('id');
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('lecturer_subscription');
    }
}
