                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="navbar-brand">
                            <span class="text-capitalize"><?php echo e(__('Welcome')); ?> <?php echo e(Auth::user()->fname); ?> <?php echo e(Auth::user()->lname); ?></span>
                        </a>
                    </li>
        ...
        <div class="container text-dark  pb-0 mb-0">
          ...
          <div class="copyright pt-0 mt-0  pb-0 mb-0">
            &copy;
              ...
              </script> developed by <a href="<?php echo e(url('https://www.instagram.com/captain_burah')); ?>" target="_blank" class="text-dark" >
              Captain Burah
        ...
        // ---------------- Tab 01: Image preview -----------------------------
            ...
            inpFile.addEventListener("change", function(){
                ...
                if (file){
                    ...
                    previewImage.setAttribute("src", "<?php echo e(asset('img/profile/tutors.png')); ?>");
                }
            });
        // --------------- /Tab 01: Image preview -----------------------------
