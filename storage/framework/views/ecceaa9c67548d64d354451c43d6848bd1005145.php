      ...
      <div class="row">
        <div class="col-lg-6 col-md-6 ml-auto mr-auto my-auto section-LecReg" id="LecReg">
            <div class="card my-auto">
              <!---------------------- SignUp Heading -------------------------------->
                <?php if(isset($url)): ?>
                    <form class="form" method="POST" action='<?php echo e(url(app()->getLocale() . '/tutor/login')); ?>' aria-label="<?php echo e(__('Login')); ?>">
                <?php else: ?>
                    <form class="form" method="POST" action='<?php echo e(url(app()->getLocale() . '/student/login')); ?>' aria-label="<?php echo e(__('Login')); ?>">
                <?php endif; ?>
                <?php echo csrf_field(); ?>
                <div 
                    <?php if(isset($url)): ?>
                    ...
                    <?php if(isset($url)): ?>
                        <h3 class="card-title mb-0 pb-0 font-weight-bold"><i class="fa fa-graduation-cap"></i>&nbsp <?php echo e(__('Tutor Login')); ?></h3>
                        <span class="mb-0 pb-0" style="font-size: .9rem;">
                            <?php echo e(__("It's quick & easy")); ?>

                          </span>
                    <?php else: ?>
                        <h3 class="card-title mb-0 pb-0 font-weight-bold"><i class="fa fa-child"></i>&nbsp <?php echo e(__('Student Login')); ?></h3>
                        <span class="mb-0 pb-0" style="font-size: .9rem;">
                            <?php echo e(__("It's quick & easy")); ?>
                ...
                <p class="description text-center mb-0 pb-0 mt-1">
                    <?php if(isset($url)): ?>
                        <?php echo e(__('Tutor Form')); ?>    
                    <?php else: ?>
                        <?php echo e(__('Student Form')); ?>
              ...
              <!---------------------- SignUp Body -------------------------------->
                <div class="card-body col-md-12">
                    <div class="row col-md-12 mx-auto">
                        <?php if($errors->any()): ?>
                            <p class="text-light bg-danger px-2 text-center"><?php echo e($errors->first('message')); ?></p>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="col-md-12 mx-auto text-center">
                            ...
                            <a class="text-primary" 
                                <?php if(isset($url)): ?>
                                    href="<?php echo e(url(app()->getLocale() . '/tutor_registration')); ?>"
                                <?php else: ?>
                                    href="<?php echo e(route('register', app()->getLocale() )); ?>"
                                <?php endif; ?>
                                >
                                    <h5><b><?php echo e(__('Create account')); ?></b></h5>
                            </a>
                            <div class="text-right">
                                <a class="btn btn-link text-left mx-0 px-0 pb-0 mb-0" href="<?php echo e(route('password.request', app()->getLocale())); ?>">
