    ...
    <div class="container">
      <div class="row mx-auto">
        ...
        <div class="col-md-6 text-center mobile-hide" >
            <h1 class="title text-center"><?php echo e(__('Pay-As-You-Go?')); ?></h1>
        </div>

        <div class=" col-md-6 text-center my-auto" >
          <div class="brand mobile-view">
            <h3 class=""><?php echo e(__('Pay-As-You-Go?')); ?></h3>
          ...
          <div class="card ml-auto" style="width: 22rem;">
            <div class="card-body">
              ...
              <div class="my-auto py-auto">
                <a href="<?php echo e(url(app()->getLocale() . '/createEstimate')); ?>" 
                  class="btn btn-warning btn-lg text-left text-dark" 
                style="min-width: 293.11px;">
                <i class="fa fa-calculator"></i>&nbsp <?php echo e(__('Create Estimate')); ?>
