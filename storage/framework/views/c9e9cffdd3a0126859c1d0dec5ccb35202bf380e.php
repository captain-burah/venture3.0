<?php $__env->startSection('content'); ?>
  ...
  style="background-image: url(<?php echo e(asset('img/bg23.jpg')); ?>); transform: translate3d(0px, 0px, 0px);">
      ...
      <div class="row">
          <div class="col-md-10 my-auto mx-auto text-center">
              <div class="brand mobile-view ">
                <h1 class="text-left">
                  <span class="text-warning"><?php echo e(__('Who')); ?></span><?php echo e(__(' are we?')); ?>

                </h1>
                <h4 class="desciption"><?php echo e(__('a young man who had a glimmer of hope in bringing change')); ?></h4>
          ...
          <div class="col-md-11 mx-auto my-auto text-right mobile-hide" >
            ...
            <h4 class="desciption"><?php echo e(__('a young man who had a glimmer of hope to bring change')); ?></h4>
            </div>
          </div>
      </div>
    </div>
  ...
  <div class="main main-raised">
        ...
        <div class="row container col-md-12 mx-auto px-3 py-0">
          <div class="col-md-3 my-auto">
            <div class="text-center mobile-hide">
              <img src="<?php echo e(asset('img/svg/dev4.svg')); ?>" class="rounded " style="height: auto; width: 20vw;">
            </div>
          </div>
          ...
          <div class="col-md-6 border-bottom border-default pt-3 pb-4 my-auto">
            <p class="text-dark text-center fontClass fontH" style="font-size: 2.5em; line-height: 1;">
              <?php echo e(__('Everything turns out great when we work together')); ?>

            </p>
            <p class="text-center description fontClass fontP" style="font-size: 1.4em; font-weight: 400;line-height: 1.5;">
              <?php echo e(('As we all have witnessed our time pass by relentlessly within the period of the Covid-19 crisis, our team spent most of their time
          ...
          <div class="col-md-3 my-auto">
            <div class="text-center mobile-hide">
              <img src="<?php echo e(asset('img/svg/dev3.svg')); ?>" class="rounded " style="height: auto; width: 20vw;">
            </div>
          </div>
        </div>
        <!---  First row --->
    ...
    <div class="section section-whoAreWe" style="background-image: url(<?php echo e(asset('img/bg19.jpg')); ?>); 
      ...
      <div class="container col-md-12">
        <div class="col-md-10 mx-auto">
          <p class="text-secondary text-center my-0 fontClass fontH mt-0 mb-3" style="font-size: 3.5em; line-height: 1;">
            ...
            <span class="text-dark my-0 fontClass "> <?php echo e(__('Team')); ?></span>
          </p>
        </div>
        <div class="row">
          <!--- Khaazen --->
          <div class="col-md-4 mx-auto">
            <div class="card bg-light image-preview mx-auto" style="width: 22rem;">
              ...
              src="<?php echo e(asset('img/faces/tkb2.png')); ?>" rel="nofollow" alt="Card image cap"
              style="">
          ...
          <div class="col-md-4 my-auto mx-auto">
            <div class="card bg-light image-preview mx-auto" style="width: 22rem;">
              <img class="image-preview__image card-img-top img-raised rounded-circle img-fluid mt-3" 
              src="<?php echo e(asset('img/faces/avatar.jpg')); ?>" rel="nofollow" alt="Card image cap"
              style="">
        ...
        <div class="row ">
          ...
          <div class="col-md-4 my-auto mx-auto">
            <div class="card bg-light image-preview mx-auto" style="width: 22rem;">
              <img class="image-preview__image card-img-top img-raised rounded-circle img-fluid mt-3" 
              src="<?php echo e(asset('img/faces/dave.jpg')); ?>" rel="nofollow" alt="Card image cap"
              style="">
              <div class="card-header card-header-info">
          ...
          <div class="col-md-4 my-auto mx-auto">
            <div class="card bg-light image-preview mx-auto" style="width: 22rem;">
              <img class="image-preview__image card-img-top img-raised rounded-circle img-fluid mt-3" 
              src="<?php echo e(asset('img/faces/marc.jpg')); ?>" rel="nofollow" alt="Card image cap"
              style="">
