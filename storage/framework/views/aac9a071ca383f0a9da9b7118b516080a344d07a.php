<?php $__env->startSection('content'); ?>
  ...
  style="background-image: url(<?php echo e(asset('img/bg8.jpg')); ?>); transform: translate3d(0px, 0px, 0px);">
    <div class="container">
      <div class="row ">
          <div class="col-md-5 text-center">
              <div class="brand mobile-view">
                  <h3 class=""><?php echo e(__('Free Registrations Now Open')); ?></h3>
              ...
              <div class="">
                ...
                style="min-width: 293.11px;">
                    <i class="fa fa-hashtag"></i>&nbsp <?php echo e(__('StudentCast Forum')); ?>

                </a>
                <a href="#" target="_blank" class="btn btn-warning btn-lg text-left text-dark" rel="nofollow" 
                style="min-width: 293.11px;">
                    <i class="fa fa-graduation-cap"></i>&nbsp <?php echo e(__('Tutor Panel')); ?>
          ...
          <div class="col-md-6 text-right mobile-hide" >
            <h1 class="title text-right"><?php echo e(__('Free Registrations Now Open')); ?></h1>
          </div>
      </div>
    </div>
  </div>
      ...
      <div class="pt-1 section-feature" id="featureSection">
        <div class="text-center">
          ...
          <div class="row">
            ...
            <h1 class="title"><?php echo e(__('What do you get?')); ?></h1>
            <h5 class="description">
              <?php echo e(__("This is the paragraph where you can write more details about your product. 
      ...
      <div class="text-center">
        ...
        <div class="container-fluid row col-md-6 mx-1 mx-auto">
          <div class="card border border-danger">
            ...
            <div class="card-body">
              <p>
                <?php echo e(__('All tutors will recieve 14 days free, to use the system without selecting a subscription 
              ...
              <a href="<?php echo e(url(app()->getLocale() . '/free_plan')); ?>" class="btn btn-white border border-danger text-danger text-capitalize">
            ...
            <div class="col-lg-3">
              <div class="card border border-warning">
                ...
                <div class="card-body">
                  ...
                  <a href="<?php echo e(url(app()->getLocale() . '/pay-as-you-go')); ?>" class="btn btn-white border border-warning text-dark  text-capitalize">
