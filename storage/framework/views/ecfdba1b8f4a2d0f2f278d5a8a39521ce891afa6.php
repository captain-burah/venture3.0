...
<head>
    ...
    <link rel="preconnect" href="<?php echo e(('https://fonts.gstatic.com')); ?>">
    <link href="<?php echo e(('https://fonts.googleapis.com/css2?family=Montserrat:wght@400;500;600;700&display=swap')); ?>" rel="stylesheet">
    ...
    <link href="<?php echo e(('https://fonts.googleapis.com/css2?family=Source+Sans+Pro:wght@200;400;600;700;900&display=swap')); ?>" rel="stylesheet">
    <!-- CSS Files -->
    
    <link href="<?php echo e(asset('css/material-kit.css?v=2.0.7')); ?>" rel="stylesheet" />
    <link href="<?php echo e(('https://cdnjs.cloudflare.com/ajax/libs/animate.css/4.1.1/animate.min.css')); ?>" rel="stylesheet"/>
...
<body class="index-page sidebar-collapse bg-dark">
    ...
    color-on-scroll="100" id="sectionsNav">
        <div class="container">
          <div class="navbar-translate my-auto">
          ...
          <div class="collapse navbar-collapse">
            ...
            <ul class="navbar-nav mx-auto text-center">
              ...
              <!------ About Us ------>
              <li class="nav-item mx-4">
                <a class="nav-link" href="<?php echo e(url(app()->getLocale() . '/about_us')); ?>">
                    <?php echo e(__('About')); ?>
              ...
              <li class="dropdown nav-item mx-4">
                ...
                <div class="dropdown-menu dropdown-with-icons">
                  ...
                  href="<?php echo e(url(app()->getLocale() . '/tutors')); ?>">
                    <?php echo e(__('Tutors Home')); ?>

                  </a>
                  <a class="dropdown-item"
                  href="<?php echo e(url('#AcademyPage')); ?>">
                    <?php echo e(__('Open Academy')); ?>

                  </a>
                  <a class="dropdown-item"
                  href="<?php echo e(url('#TutorPanel')); ?>">
                    <?php echo e(__('Open Tutor Panel')); ?>

                  </a>
                  <a class="dropdown-item"
                  href="<?php echo e(url('#StudentCast')); ?>">
                    <?php echo e(__('Open StudentCast')); ?>
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                ...
                data-original-title="Call Us On">
                  <i class="fa fa-phone"></i><?php echo e(__(' +94 77 637 1444')); ?>
    ...
    <div class="container">
      <div class="py-5 row text-secondary">
        <div class="col-12 col-md my-auto">
          ...
          <a href="<?php echo e(('https://www.instagram.com/captain_burah')); ?>" class="footer-a text-rose" target="_blank" >
            Captain Burah
          ...
          <?php $__currentLoopData = config('app.available_locales'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $locale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <li class="nav-item pb-0 footer-aa">
                  <a <?php if(app()->getLocale() == $locale): ?> 
                      ...
                      class="nav-link footer-aa" <?php endif; ?> 
                  href="<?php echo e(route(\Illuminate\Support\Facades\Route::currentRouteName(), $locale)); ?>" class="nav-link Flink footer-aa">
  ...
  <!--  Scripts -->
    ...
    <script src="<?php echo e(asset('js/material-kit.min.js?v=2.0.7')); ?>" type="text/javascript"></script>
