...
<body class="landing-page sidebar-collapse bg-ligth">
          ...
          <!---   Navbar Right   --->
              <ul class="navbar-nav ml-auto">
                <li class="nav-item">  <!---- Log-In item--->
                  <a class="nav-link"  href="<?php echo e(url(app()->getLocale() . '/login/tutor')); ?>">
                    <i class="material-icons">login</i> <?php echo e(__('Log-In')); ?>
                ...
                <li class="nav-item">
                  ...
                  <li class="nav-item">  <!---- Register item--->
                      <?php if(Route::has('login')): ?> <!-- if the route has already processed the 'login' route -->
                      <div>
                          <?php if(auth()->guard()->check()): ?> <!-- if the route is authenticated -->
                              <?php if(isset($url)): ?> <!-- if the route has a variable called 'url' -->
                                  <?php if($url === "/student"): ?> <!-- if the variable url is '/student' -->
                                    <li class="nav-item">
                                      <a href="<?php echo e(url(app()->getLocale() . '/student_dashboard')); ?>" class="nav-link">
                                        <i class="material-icons">dashboard</i> Go to Dashboard
                                      </a>
                                    </li>
                                  <?php elseif($url === "/tutors"): ?> <!-- if the variable url is '/tutors' -->
                                    <li class="nav-item">
                                      <a href="<?php echo e(url(app()->getLocale() . '/tutor')); ?>" class="nav-link">
                                        <i class="material-icons">dashboard</i> Go to Dashboard
                                      </a>
                                    </li>
                                  <?php endif; ?>
  ...
  <!--  Scripts -->
    ...
    <script src="<?php echo e(('https://cdn.jsdelivr.net/npm/sweetalert2@10')); ?>"></script>
